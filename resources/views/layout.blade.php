...
<header>
    ...
    <div class="full-bg-img">
      <div class="mask rgba-purple-light flex-center">
        ...
        <h1 class="font text-uppercase ">NES<strong class="font11">HEALTH BOLIVIA</strong></h1><hr>
          <br>
          <h5 class="font1  ">Descifrando el campo del cuerpo humano para llegar a la causa raíz y restaurar su energía para la vida</h5>
