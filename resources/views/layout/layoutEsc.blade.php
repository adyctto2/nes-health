...
<link href="https://fonts.googleapis.com/css?family=Mada" rel="stylesheet">
    ...
    <div class="full-bg-img">
      <div class="mask rgba-purple-light flex-center">
        ...
        <h3 class="font">El software de escaneo de salud <br> NES </h3><hr>
          <br>
          <h5 class="font1">(Re) Evalúe el campo del cuerpo humano en solo unos segundos para un <br> análisis detallado que aborde los tres factores críticos para la salud: <br> información, energía y fisiología</h5>
