...
<link href="https://fonts.googleapis.com/css?family=Mada" rel="stylesheet">
    ...
    <div class="full-bg-img">
      <div class="mask rgba-purple-light flex-center">
        ...
        <h3 class="font"> Infoceuticos</h3><hr>
          <br>
          <h5 class="font1">Apoye el flujo de energía e información del cuerpo con nuestra gama de <br> soluciones impresas con información bio patentada.</h5>
