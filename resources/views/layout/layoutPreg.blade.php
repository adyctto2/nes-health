...
<link href="https://fonts.googleapis.com/css?family=Mada" rel="stylesheet">
        ...
        <style>
            ...
            .view {
                background: url(../img/productos/contactos.jpg)no-repeat center center;
      ...
      <ul class="navbar-nav ml-auto ">
        ...
        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item text-capitalize" href="{{route('ensayosClinicos')}}">Ensayos clínicos</a>
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="{{asset('PFrecuentes')}}">Preguntas Frecuentes</a>
            </li>
            <li class="nav-item">
    ...
    <div class="full-bg-img">
      <div class="mask rgba-purple-light flex-center">
        ...
        <h3 class="font" style="font-size: 60px;">Preguntas Frecuentes</h3>
          <br>
