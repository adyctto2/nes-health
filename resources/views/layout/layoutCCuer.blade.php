...
<link href="https://fonts.googleapis.com/css?family=Mada" rel="stylesheet">
    ...
    <div class="full-bg-img">
      <div class="mask rgba-purple-light flex-center">
        ...
        <h3 class="font">Campo del cuerpo humano</h3><hr>
          <br>
          <h5 class="font1">El campo del cuerpo humano es una red compleja y estructurada de campos que interpenetra el cuerpo físico y subyace a toda fisiología.</h5>
