...
<link href="https://fonts.googleapis.com/css?family=Mada" rel="stylesheet">
        ...
        <style>
            ...
            .view {
                background: url(../../img/productos/science.jpg)no-repeat center center;
    ...
    <div class="full-bg-img">
      <div class="mask rgba-purple-light flex-center">
        ...
        <h3 class="font">La eficacia de NES Infoceuticals <br> en la calidad de vida relacionada con la salud y la <br> pérdida de peso en personas con <br>sobrepeso y obesas</h3>
          <br>
