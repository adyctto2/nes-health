...
<link href="https://fonts.googleapis.com/css?family=Mada" rel="stylesheet">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto ">
        ...
        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item text-capitalize" href="{{route('casosEstudio')}}">Estudios de caso</a>
          <a class="dropdown-item text-capitalize" href="{{route('ensayosClinicos')}}">Ensayos clínicos</a>
        </div>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="{{route('resultados')}}">Resultados</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="{{route('PFrecuentes')}}">Preguntas Frecuentes</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="{{route('contactenos')}}">Contáctenos</a>
            </li>
        <!-- <li class="nav-item">
    ...
    <div class="full-bg-img">
      <div class="mask rgba-purple-light flex-center">
        ...
        <!-- <h1 class="text-uppercase" style="color: blue">NES<strong class="font11"style="color: #ffc107 ">HEALTH </strong> <strong style="color: white ">BOLIVIA</strong> </h1><hr> -->
          <br>
          <h5 class="font1" style="font-size: 40px;">Descifrando el campo del cuerpo <br> humano para llegar a la causa <br> raíz y restaurar su energía para  la vida</h5>
          <!-- <button type="button" class="btn btn-outline-primary waves-effect"><strong>Saber más</strong></button> -->
